...
window.webcam = {
	...
	swf_url: 'components/webcam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'components/webcam/shutter.mp3', // URI to shutter.mp3 sound
	api_url: 'avartarUpload.php', // URL to upload script
